...
public partial struct WavAudioFile
{
    public UnityEngine.AudioClip ToAudioClip(string name = "Wav")
    {
        var audioClip = UnityEngine.AudioClip.Create(name, Data.Length, (int)NumChannels, (int)SampleRate, false);
        audioClip.SetData(DataAsFloat, 0);
        return audioClip;
    }
